...
import { ArrowLeft, CalendarCheck, MapPin, BadgeInfo, GraduationCap, Award, Clock, Star, Heart, Zap, Shield, Users, Phone, } from "lucide-react";
...
function getScheduleDates(schedule) {
  ...
  // you can get the output as desired that is most recent comes first or the earliest comes first.
}
          ...
          <div className={doctorDetailStyles.profileGrid}>
            <div className={doctorDetailStyles.leftColumn}>
              <div className={doctorDetailStyles.avatarContainer}>
                ...
                <img src={ doctor.imageUrl || doctor.image || "/placeholder-doctor.jpg"} alt={doctor.name}
              ...
              <div className={doctorDetailStyles.statsGrid}>
                ...
                <div className={doctorDetailStyles.statBox}>
                  <Users className={`${doctorDetailStyles.statIcon} ${doctorDetailStyles.usersIcon}`} />
                  <div className={doctorDetailStyles.statValue}>
                    {doctor.patients}
                  </div>
                ...
                <div className={doctorDetailStyles.summaryContainer}>
                  ...
                  <div className={doctorDetailStyles.paymentContainer}>
                    ...
                    <div className={doctorDetailStyles.paymentOptions}>
                      <label className={`${doctorDetailStyles.paymentOption} ${
                          paymentMethod === "Cash"
