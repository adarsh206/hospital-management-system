  ...
  return (
    <>
      ...
      <div className={navbarStylesDr.desktopMenu}>
        <div className={navbarStylesDr.desktopMenuItems}>
            {navItems.map(({name, to, Icon}) => (
                <NavLink key={to} to={to} end={to === basePath} className={({isActive}) => `${navbarStylesDr.baseLink} ${isActive ? navbarStylesDr.activeLink : navbarStylesDr.inactiveLink}`}
      ...
      <div className={navbarStylesDr.rightActions}>
        <button className={navbarStylesDr.logoutButtonDesktop} onClick={() => {
