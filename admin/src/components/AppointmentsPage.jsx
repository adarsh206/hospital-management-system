                    ...
                    <div className={pageStyles.headerControlsSection}>
                        <div className="flex flex-col md:flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
                            <div className={pageStyles.searchContainer}>
                                ...
                                <input className={pageStyles.searchInput} placeholder="Search doctor, patients speciality or mobile" value={query} onChange={(e) => setQuery(e.target.value)} />
                            </div>
                                ...
                                <div
                                    ...
                                    <div className="flex items-center justify-between gap-3 flex-wrap">
                                        ...
                                        {isAdmin && (
                                            ...
                                            >
                                            {isDisabled ? isCompleted ? "Completed" : "Admin Cancelled" : "Admin Cancel"}
                                            </button>
                                        )}
                                        </div>
                                    </div>
