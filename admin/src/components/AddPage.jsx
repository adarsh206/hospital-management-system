        ...
        <div className={s.maxWidthContainer + " " + s.formContainer}>
            <form onSubmit={handleAdd} className={s.formGrid}>
              ...
              />
                ...
                <input className={s.inputBase} placeholder='Patients' value={form.patients} onChange={(e) => setForm({ ...form, patients: e.target.value})} />
                <input className={s.inputBase} placeholder='Success Rate' value={form.success} onChange={(e) => setForm({ ...form, success: e.target.value})} />
                <input className={s.inputBase} placeholder='Doctor Email' value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value})} />

                <div className='relative'>
                  <input className={s.inputBase + " " + s.inputWithIcon} placeholder='Doctor Password' type={showPassword ? "text" : "password"} value={form.password} onChange={(e) => setForm({...form, password: e.target.value})} />
                  <button type='button' onClick={() => setShowPassword((s) => !s)} className={s.passwordToggleButton + " " + s.cursorPointer}>
                ...
                <textarea className={s.textareaBase + "md:col-span-2"} rows={3} placeholder='About Doctor' value={form.about} onChange={(e) => setForm({...form, about: e.target.value})}>
                </textarea>
