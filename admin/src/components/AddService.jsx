...
const AddService = ({ serviceId }) => {
  ...
  function handleImageChange(e) {
    ...
    // remove the existing image if user choose a new file.
    setRemoveImage(false);
    setHasExistingImage(false);
  }
  ...
  async function handleSubmit(e) {
    e.preventDefault();
    if (!validate()) {
      showToast("error", "Missing Fields", "Please fill all required fields before submitting.");
      return;
    }
