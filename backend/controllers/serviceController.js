...
export async function getServices(req, res){
    try {
        ...
        return res.status(500).json({
            success: false,
            message: "Server Error or Failed to get services."
        });
    }
}
...
export async function getServiceById(req, res){
    try {
        ...
        return res.status(500).json({
            success: false,
            message: "Server Error or Failed to get service by id."
        });
    }
}
...
export async function updateService(req, res){
    try {
     ...
     const updated = await Service.findByIdAndUpdate(id, updateData, { new: true, 
        ...
        return res.status(500).json({
            success: false,
            message: "Server Error or Failed to update service."
        });
    }
}
...
export async function deleteService(req, res){
    try {
        ...
        return res.status(500).json({
            success: false,
            message: "Server Error or Failed to delete service."
        });
    }
}